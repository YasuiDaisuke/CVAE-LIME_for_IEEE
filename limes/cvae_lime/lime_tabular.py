...
from limes.cvae_lime.discretize import QuartileDiscretizer
from limes.cvae_lime.discretize import DecileDiscretizer
from limes.cvae_lime.discretize import EntropyDiscretizer
from limes.cvae_lime.discretize import BaseDiscretizer
from limes.cvae_lime.discretize import StatsDiscretizer
...
class LimeTabularExplainer(object):
    ...
    def __init__(self,
        ...
        if auto_encoder_setting['auto_encoder_training'] == True:
            ...
            AE_training(X_train = training_data, y_train = training_labels, auto_encoder_setting = auto_encoder_setting)
    ...
    def explain_instance(self,
        ...
        for label in labels:
            (ret_exp.intercept[label],
             ...
             ret_exp.score, 
             ret_exp.local_pred,
             ret_exp.additional_score) = self.base.explain_instance_with_data(
                    scaled_data,
                    yss,
                    distances,
                    label,
